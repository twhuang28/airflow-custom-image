...
--image-tag 2.1.2-python3.6-base-v1 \
...
--additional-python-deps "confluent-kafka==1.5.0 psycopg2==2.9.1 pytest pyspark==3.1.2 apache-airflow-providers-apache-spark"

docker tag 2.1.1-python3.6-base-v2 twhuang28/airflow:2.1.1-python3.6-base-v2

docker push twhuang28/airflow:2.1.1-python3.6-base-v2
```